  ...
  return (
    <div className="min-h-screen bg-gray-50 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="bg-white/10 backdrop-blur-md shadow-lg rounded-lg p-8">
            {/* Termly iframe embed */}
            <iframe
              src="https://app.termly.io/embed/policy/86356b42-5f4f-4bbc-8b19-373c792a3f7e"
              width="100%"
              height="800"
              frameBorder="0"
              allowFullScreen
      ...
      <style jsx>{`
        ...
        /* Override Termly styles for white text */
        :global([data-name="termly-embed"] *) {
          color: white !important;
        }
        
        :global([data-name="termly-embed"] a) {
          color: #93c5fd !important;
          text-decoration: underline;
        }
        
        :global([data-name="termly-embed"] h1),
        :global([data-name="termly-embed"] h2),
        :global([data-name="termly-embed"] h3) {
          color: white !important;
